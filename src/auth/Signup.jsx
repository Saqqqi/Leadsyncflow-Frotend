            ...
            <div className="w-full max-w-4xl pt-16">
                ...
                <div className="rounded-2xl p-8"
                    ...
                    <div className="text-center mb-10">
                        <h2 className="text-3xl font-bold mb-2 uppercase tracking-tight" style={{ color: 'var(--text-primary)' }}>
                            Join the Flow
                        </h2>
                    ...
                    <form className="space-y-8" onSubmit={handleSubmit}>
                        <div className="grid grid-cols-2 gap-6">
                            ...
                            {/* Gender */}
                            <div className="space-y-2">
                                <label className="text-sm font-bold opacity-70 ml-1">Gender</label>
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                        <svg className="h-5 w-5 opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <select name="sex" required value={formData.sex} onChange={handleChange}
                                        className="w-full pl-12 pr-10 py-3.5 rounded-xl border focus:outline-none focus:ring-2 transition-all appearance-none"
                                        style={{ borderColor: "var(--border-primary)", backgroundColor: "rgba(255,255,255,0.03)", color: "var(--text-primary)" }}>
                            ...
                            {/* Department */}
                            <div className="space-y-2">
                                <label className="text-sm font-bold opacity-70 ml-1">Department</label>
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                        <svg className="h-5 w-5 opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            {/* Password */}
                            <div className="space-y-2">
                                <label className="text-sm font-bold opacity-70 ml-1">Password</label>
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                        <svg className="h-5 w-5 opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <input name="password" type={showPassword ? "text" : "password"} required value={formData.password} onChange={handleChange}
                                        className="w-full pl-12 pr-12 py-3.5 rounded-xl border focus:outline-none focus:ring-2 transition-all"
                                        style={{ borderColor: "var(--border-primary)", backgroundColor: "rgba(255,255,255,0.03)", color: "var(--text-primary)" }}
                                        placeholder="••••••••" />
                            ...
                            <div className="space-y-2 relative">
                                <label className="text-sm font-bold opacity-70 ml-1">Confirm Password</label>
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                        <svg className="h-5 w-5 opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <input name="confirmPassword" type={showConfirmPassword ? "text" : "password"} required value={formData.confirmPassword} onChange={handleChange}
                                        className={`w-full pl-12 pr-12 py-3.5 rounded-xl border focus:outline-none focus:ring-2 transition-all ${!passwordMatch && formData.confirmPassword ? 'border-red-500 ring-red-500/20' : ''}`}
                                        style={{
                                ...
                                {!passwordMatch && formData.confirmPassword && (
                                    <p className="absolute -bottom-5 left-1 text-[10px] font-bold text-red-500 animate-fadeIn uppercase tracking-wider">
                        ...
                        <div className="pt-8 space-y-6">
                            <div className="flex justify-end">
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="px-10 py-3.5 rounded-xl text-sm font-bold text-white transition-all duration-200 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-offset-2 transform hover:-translate-y-1 hover:scale-105 active:scale-95"
                                    style={{
                                        background: loading
