    ...
    return (
        <div className="p-4 sm:p-6 md:p-8 space-y-6 animate-fadeIn max-w-[1800px] mx-auto">
            ...
            <div className="bg-[var(--bg-secondary)] border border-[var(--border-primary)] rounded-[40px] p-8 shadow-2xl relative overflow-hidden">
                        ...
                        {view !== 'TEAM' && (
                            <div className="flex items-center gap-3">
                                <select
                                    ...
                                    className="px-5 py-3 rounded-2xl border border-[var(--border-primary)] bg-[var(--bg-tertiary)] text-xs font-black text-[var(--text-primary)] outline-none ring-[var(--accent-primary)]/20 focus:ring-2 cursor-pointer"
                                >
                ...
                {view !== 'TEAM' && (
                    <div className="flex gap-2 mt-8 border-b border-[var(--border-primary)]/50 pb-px overflow-x-auto relative z-10 scrollbar-hide">
                        {[
                            ...
                            <button
                                ...
                                className={`group flex items-center gap-2 px-6 py-4 text-sm font-black transition-all whitespace-nowrap border-b-2 ${activeTab === tab.id
                                    ? 'text-[var(--accent-primary)] border-[var(--accent-primary)]'
                                    : 'text-[var(--text-tertiary)] border-transparent hover:text-[var(--text-primary)]'
                                    }`}
                            >
                                {tab.label}
                                <span className={`px-2 py-0.5 rounded-lg text-[10px] ${activeTab === tab.id ? 'bg-[var(--accent-primary)] text-white' : 'bg-[var(--bg-tertiary)] group-hover:bg-[var(--border-primary)]'
                                    }`}>
                                    {tab.count}
                                </span>
                            </button>
