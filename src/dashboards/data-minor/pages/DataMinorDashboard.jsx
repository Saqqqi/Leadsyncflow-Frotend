...
export default function DataMinorDashboard() {
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-6">Data Minor Dashboard</h1>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-lg font-semibold mb-4">Data Processing Status</h2>
        <p className="text-gray-500">No data processing tasks available yet.</p>
      </div>
    </div>
  );
}
